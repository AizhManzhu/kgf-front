  ...
  <q-page class="q-page-container">
    <div class="q-pa-md">
      <q-card class="my-card" flat bordered>
        <q-card-section>
          <div class="text-h6" style="padding-left:15px">Участник: {{event}}</div>
        </q-card-section>
        <q-card-section class="column">
          <div class="row">
            <div class="col-6 q-pa-md">
              <q-input outlined v-model="event" label="Event" />
            </div>
            <div class="col-6 q-pa-md">
        ...
        <q-card-actions>
          ...
          <q-btn flat color="primary" v-if="$can('create-member')" label="Сохранить" v-on:click="save()"/>
        </q-card-actions>
      </q-card>
    </div>
  </q-page>
...
export default {
  ...
  methods: {
    save() {
      ...
      this.$store.dispatch('members/store', data);
    },
  },
};
</script>
